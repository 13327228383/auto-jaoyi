...
CFG = {
    ...
    #   回测 research/backtest_halt_threshold.py（真实high/low、对齐实盘MIN_HOLD=5+3%跟踪+冷却+T+1+滑点0.1%+万2.38）：
    #   3%~5% 全期年化5.11%→9.43%、样本外11.77%→22.31%、样本外Calmar0.39→1.02、回撤-40.5%→-36.4%；
    #   3%太敏感频繁错失反弹(比无限还差)，5%最平衡，6%回撤回升→采纳5%。
